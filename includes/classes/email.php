...
/*
  ...
  $Id: email.php,v 1.5 2004/09/11 12:07:45 ptosh Exp $
*/
 ...
 */
    ...
    function add_text($text = '') {
      ...
      $this->text = mb_convert_encoding(mb_convert_kana($text, "KV"), 'JIS', 'UTF-8');
    }
 ...
 */
    ...
    function send($to_name, $to_addr, $from_name, $from_addr, $subject = '', $headers = '') {
      ...
      // tamura 2002/05/08
/*
      if (ereg("[ ]*(.+[^ ]+)[ ]*<([^@]+@[^@]+)>[ ]*", $from_addr, $a_regs)) {//非推奨 20140316
        $from_name .= $a_regs[1];
        $from_addr = $a_regs[2];
      }
*/
  ...
  /* r5
      ...
      $to    = ($to_name != '')
          ? ('"' . mb_encode_mimeheader(mb_convert_kana($to_name . TEXT_KEISYOU, "KV"), 'ISO-2022-JP') . '" <' . $to_addr . '>')
          : $to_addr;
      $from  = ($from_name != '')
  ...
  r5_eof r8 */
      ...
      $to    = ($to_name != '')
          ? ('"' . mb_encode_mimeheader(mb_convert_kana($to_name, "KV"), 'ISO-2022-JP', "B", $this->lf) . '" <' . $to_addr . '>')
          : $to_addr;
      $from  = ($from_name != '')
          ? ('"' . mb_encode_mimeheader(mb_convert_kana($from_name, "KV"), 'ISO-2022-JP', "B", $this->lf)  . '" <' . $from_addr. '>')
  //r8_eof
  ...
  /* delete r8
      // hiroshi_sato : Addtional Return-Path Header 2004/01/20
