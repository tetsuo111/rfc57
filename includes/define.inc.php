...
//サイト設定（configureへ引っ越ししました）
//define('SITE_NAME', 'Ripple Wallet'); //サイト名
//define('SITE_OWNER', 'Ripple Wallet'); //サイト運営責任者名
//define('TITLE', 'Ripple Wallet');  //ブラウザ表示タイトル

//メール設定
//define('EMAIL_FROM', 'Ripple Wallet <info@ripplejp.us>'); //顧客に送られるメールの差出人名とアドレス
//define('SITE_OWNER_EMAIL', 'info@ripplejp.us');  //サイトで使用するメールアドレス
//define('SITE_OWNER_TELL', '0363041771');  //サイトで使用するメールアドレス

//サーチエンジン対策のURLを使用(開発中)
define('SEARCH_ENGINE_FRIENDLY_URLS', 'false'); //サイトの全リンクでサーチエンジン対策用URLの使用・不使用設定. true (使用) false(不使用)

//最小値
define('NAME_MIN_LENGTH', '1'); //名前の文字数の最小値設定
define('DOB_MIN_LENGTH', '10'); //生年月日の文字数の最小値設定
define('EMAIL_MIN_LENGTH', '6'); //E-Mail アドレスの文字数の最小値設定
define('ADDRESS_MIN_LENGTH', '1'); //住所の文字数の最小値設定
define('COMPANY_LENGTH', '2'); //会社名の文字数の最小値設定
define('ADDR_ZIP_A_LENGTH', '3'); //郵便番号の文字数の最小値設定
define('ADDR_ZIP_B_LENGTH', '4'); //郵便番号の文字数の最小値設定
define('TEL_MIN_LENGTH', '3'); //電話番号の文字数の最小値設定
define('PASSWORD_MIN_LENGTH', '4'); //パスワードの文字数の最小値設定 //活用
...
//ログの格納先
define('PAGE_PARSE_TIME_LOG', '/var/log/tep_page_parse_time.log'); //ページのパースログを保存するディレクトリとファイル名設定
...
//Google Maps API Key
//define('GMAP_API_KEY', 'ABQIAAAAmYRbUbZoTXONxt5eD4Z2wxRAaEUBEzC_7cG7aBViuysbBaoWzhSYy7fnuN9Ib4ItcIBGIi2_Sdacnw');
