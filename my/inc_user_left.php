...
if($_COOKIE['bctype'] == '21'){
	...
	$menu_ul.= '<a class="u_menu_a" href="event.php"><li>イベント情報</li></a>';
	$menu_ul.= '<a class="u_menu_a" href="edit_user_info.php"><li>会員情報</li></a>';
	$menu_ul.= '<a class="u_menu_a" href="affiliate.php"><li>アフィリエイトバナー</li></a>';
	$menu_ul.= '<a class="u_menu_a" href="order.php"><li>商品購入</li></a>';
	$menu_ul.= '<a class="u_menu_a" href="order_regular.php"><li>定期購入</li></a>';
	$menu_ul.= '<a class="u_menu_a" href="introduction.php"><li>ご招待実績</li></a>';
	$menu_ul.= '<span class="u_menu_a" onclick="alert(\'準備中\');"><li>報酬</li></span>';
	$menu_ul.= '<a class="u_menu_a" href="doc_dl.php"><li>資料ダウンロード</li></a>';
	$menu_ul.= '<a class="u_menu_a" href="qanda.php"><li>Q&A　よくある質問</li></a>';
	$menu_ul.= '<a class="u_menu_a" href="inquiry.php"><li>お問い合わせ</li></a>';
	$menu_ul.= $input_wc_buy;
